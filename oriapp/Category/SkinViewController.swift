...
import Kingfisher
import Alamofire
class SkinViewController: BaseViewController{
var transactions: [Products] = []
    ...
    func loadTransactions() {
                ...
                makeApiCall(path: "/product/cat_product/" + String(5),
...
extension SkinViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
      ...
      let cell = tableView.dequeueReusableCell(withIdentifier: "skincell")!
...
extension SkinViewController: UITableViewDelegate {
